    ...
    <Card
      render={
        <button
          ...
          className="group relative flex h-full w-full flex-col items-start justify-between gap-3 p-5 text-start outline-none transition-colors hover:bg-accent/40 focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-1 focus-visible:ring-offset-background"
        />
      }
    >
      {Icon ? (
      ...
      {widget.badge ? (
        <Badge
          variant="secondary"
          className="pointer-events-none absolute top-3 right-3 text-[11px]"
        >
          {widget.badge}
        </Badge>
      ) : null}
